...
@section('content')
    <main class="min-h-screen flex items-center justify-center bg-gray-50 px-4">
        <a
            ...
            class="inline-flex items-center gap-4 rounded-2xl bg-[#4A154B] px-12 py-8 text-2xl font-semibold text-white shadow-xl transition hover:bg-[#611f64] focus:outline-none focus:ring-4 focus:ring-purple-300"
        >
            <svg x-show="!loading" class="h-10 w-10" viewBox="0 0 122.8 122.8" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
            ...
            <svg x-show="loading" x-cloak class="h-10 w-10 animate-spin" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                <circle cx="12" cy="12" r="10" stroke="currentColor" stroke-opacity="0.25" stroke-width="3"/>
                <path d="M22 12a10 10 0 0 1-10 10" stroke="currentColor" stroke-width="3" stroke-linecap="round"/>
            </svg>
            <span x-text="loading ? 'Connecting…' : 'Sign in with Slack'">Sign in with Slack</span>
        </a>
    </main>
@endsection
